...
export const AfterFooterSection = () => {
  return (
    ...
    >
      <div
        className="w-full px-0 sm:px-4 lg:px-16 overflow-hidden p-0 m-0 flex items-center justify-center"
        style={{ height: "300px" }}
      >
        <div className="flex items-center justify-center gap-0 p-0 m-0 h-full max-w-6xl">
